				...
				<div className="flex-grow">
					<div className="inline-flex w-full flex-col items-center justify-start gap-6 p-16">
						...
						<div className="mb-10 w-[686px] text-center">
							Found a cool AI product you want everyone to know about? Or maybe you made one yourself and
							want the world to know about it? You&apos;re in the right place.
						</div>
						...
						<div className="inline-flex max-w-lg gap-3 text-sm">
							...
							<p>
								{" "}
								We use AI to extract information from this website to categorize it, please make sure
								your website contains enough information.
							</p>
						</div>
					</div>
				</div>
